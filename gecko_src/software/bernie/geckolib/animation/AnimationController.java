				...
				for (BoneAnimation boneAnimation : this.currentAnimation.animation().boneAnimations()) {
					...
					if (!rotationKeyFrames.xKeyframes().isEmpty()) {
						boneAnimationQueue.addNextRotation(null, adjustedTick, this.transitionLength, boneSnapshot, bone.getInitialSnapshot(),
								getAnimationPointAtTick(rotationKeyFrames.xKeyframes(), 0, true, class_2351.field_11048),
								getAnimationPointAtTick(rotationKeyFrames.yKeyframes(), 0, true, class_2351.field_11052),
								getAnimationPointAtTick(rotationKeyFrames.zKeyframes(), 0, true, class_2351.field_11051));
					}

					if (!positionKeyFrames.xKeyframes().isEmpty()) {
						boneAnimationQueue.addNextPosition(null, adjustedTick, this.transitionLength, boneSnapshot,
								getAnimationPointAtTick(positionKeyFrames.xKeyframes(), 0, false, class_2351.field_11048),
								getAnimationPointAtTick(positionKeyFrames.yKeyframes(), 0, false, class_2351.field_11052),
								getAnimationPointAtTick(positionKeyFrames.zKeyframes(), 0, false, class_2351.field_11051));
					}

					if (!scaleKeyFrames.xKeyframes().isEmpty()) {
						boneAnimationQueue.addNextScale(null, adjustedTick, this.transitionLength, boneSnapshot,
								getAnimationPointAtTick(scaleKeyFrames.xKeyframes(), 0, false, class_2351.field_11048),
								getAnimationPointAtTick(scaleKeyFrames.yKeyframes(), 0, false, class_2351.field_11052),
								getAnimationPointAtTick(scaleKeyFrames.zKeyframes(), 0, false, class_2351.field_11051));
					}
				}
			}
		}
		...
		for (BoneAnimation boneAnimation : this.currentAnimation.animation().boneAnimations()) {
			...
			if (!rotationKeyFrames.xKeyframes().isEmpty()) {
				boneAnimationQueue.addRotations(
						getAnimationPointAtTick(rotationKeyFrames.xKeyframes(), adjustedTick, true, class_2351.field_11048),
						getAnimationPointAtTick(rotationKeyFrames.yKeyframes(), adjustedTick, true, class_2351.field_11052),
						getAnimationPointAtTick(rotationKeyFrames.zKeyframes(), adjustedTick, true, class_2351.field_11051));
			}

			if (!positionKeyFrames.xKeyframes().isEmpty()) {
				boneAnimationQueue.addPositions(
						getAnimationPointAtTick(positionKeyFrames.xKeyframes(), adjustedTick, false, class_2351.field_11048),
						getAnimationPointAtTick(positionKeyFrames.yKeyframes(), adjustedTick, false, class_2351.field_11052),
						getAnimationPointAtTick(positionKeyFrames.zKeyframes(), adjustedTick, false, class_2351.field_11051));
			}

			if (!scaleKeyFrames.xKeyframes().isEmpty()) {
				boneAnimationQueue.addScales(
						getAnimationPointAtTick(scaleKeyFrames.xKeyframes(), adjustedTick, false, class_2351.field_11048),
						getAnimationPointAtTick(scaleKeyFrames.yKeyframes(), adjustedTick, false, class_2351.field_11052),
						getAnimationPointAtTick(scaleKeyFrames.zKeyframes(), adjustedTick, false, class_2351.field_11051));
			}
		}
	...
	private AnimationPoint getAnimationPointAtTick(List<Keyframe<MathValue>> frames, double tick, boolean isRotation,
		...
		if (isRotation) {
			if (!(currentFrame.startValue() instanceof Constant)) {
				...
				if (axis == class_2351.field_11048 || axis == class_2351.field_11052)
					startValue *= -1;
			}
