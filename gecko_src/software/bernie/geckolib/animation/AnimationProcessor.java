	...
	public void tickAnimation(T animatable, GeoModel<T> model, AnimatableManager<T> animatableManager, double animTime, AnimationState<T> state, boolean crashWhenCantFindBone) {
		...
		for (GeoBone bone : getRegisteredBones()) {
			if (!bone.hasRotationChanged()) {
				...
				bone.setRotX((float)class_3532.method_16436(percentageReset, saveSnapshot.getRotX(), initialSnapshot.getRotX()));
				bone.setRotY((float)class_3532.method_16436(percentageReset, saveSnapshot.getRotY(), initialSnapshot.getRotY()));
				bone.setRotZ((float)class_3532.method_16436(percentageReset, saveSnapshot.getRotZ(), initialSnapshot.getRotZ()));
			...
			if (!bone.hasPositionChanged()) {
				...
				bone.setPosX((float)class_3532.method_16436(percentageReset, saveSnapshot.getOffsetX(), initialSnapshot.getOffsetX()));
				bone.setPosY((float)class_3532.method_16436(percentageReset, saveSnapshot.getOffsetY(), initialSnapshot.getOffsetY()));
				bone.setPosZ((float)class_3532.method_16436(percentageReset, saveSnapshot.getOffsetZ(), initialSnapshot.getOffsetZ()));
			...
			if (!bone.hasScaleChanged()) {
				...
				bone.setScaleX((float)class_3532.method_16436(percentageReset, saveSnapshot.getScaleX(), initialSnapshot.getScaleX()));
				bone.setScaleY((float)class_3532.method_16436(percentageReset, saveSnapshot.getScaleY(), initialSnapshot.getScaleY()));
				bone.setScaleZ((float)class_3532.method_16436(percentageReset, saveSnapshot.getScaleZ(), initialSnapshot.getScaleZ()));
